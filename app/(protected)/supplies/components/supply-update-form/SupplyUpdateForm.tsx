...
const formSchema = z.object({
  ...
  price: z.number({ required_error: "El campo es requerido" }).max(9999999, { message: 'El precio es demasiado alto' }),
  total: z.number({ required_error: "El campo es requerido" }).max(9999999, { message: 'El total es demasiado alto' }),
