...
const formProductSchema = z.object({
  ...
  sale_price: z.number({required_error: "El campo es requerido", invalid_type_error: "Se espera un número"}).min(111, {message: "Ingrese mínimo 3 números"}).max(99999999999, {message: 'El precio es demasiado largo'})
});
