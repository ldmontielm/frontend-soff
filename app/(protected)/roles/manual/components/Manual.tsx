...
<div className="flex justify-between flex-col md:flex-row items-center mb-9 p-5 border rounded bg-gray-100">
  <div className="w-full p-4">
    ...
    <p className="text-justify text-md">Dirígete hacia la esquina superior derecha de la tabla, allí encontrarás un botón 
    etiquetado como {`'Inactivos'`}. Al presionar este botón, la tabla se actualizará, permitiéndote filtrar y mostrar exclusivamente los roles que 
    actualmente se encuentran inactivos.</p>
  </div>
  <div className="w-auto">
...
<div className="flex justify-between flex-col md:flex-row items-center p-5 mb-9 border rounded">
  ...
  <div className="w-full p-4">
    ...
    <h3 className="text-black text-2xl font-bold">Botón de Cambio de Estado</h3>
    <p className="text-justify text-md">Muévete con el puntero hacia la columna {`'Estado'`}; allí verás un botón etiquetado como {`'Inactivo'`}. Este botón te permite cambiar 
    el estado de un rol; al hacer presionar sobre él, el rol desaparecerá de la tabla, ya que esta solo muestra los roles Inactivos.</p>
  </div>
</div>
