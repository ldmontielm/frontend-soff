...
<div className="flex justify-between flex-col md:flex-row items-center p-5 mb-9 border rounded">
  ...
  <div className="w-full p-4">
    ...
    <p className="text-justify text-md mb-2">Una vez que hayas desplegado el menú según las instrucciones anteriores, notarás la presencia de una pequeña casilla marcada con el nombre de una columna. Al dirigir el puntero hacia una casilla azul y hacer clic, podrás observar en tiempo real cómo la información de esa columna desaparece de la tabla. Si decides volver a marcar la casilla, la columna reaparecerá instantáneamente.</p>
    <p className="mb-2"></p>
...
<div className="flex justify-between flex-col md:flex-row items-center p-5 mb-9 border rounded">
  ...
  <div className="w-full p-4">
    ...
    <p className="text-justify text-md">Muévete con el puntero hacia la columna 'Estado'; allí verás un botón etiquetado como 'Activo'. Este botón te permite cambiar el estado de un rol; al hacer presionar sobre él, el rol desaparecerá de la tabla, ya que esta solo muestra los roles activos.</p>
    <p></p>
    <ul>
      <li>
...
<div className="flex justify-between flex-col md:flex-row items-center mb-9 p-5 border rounded bg-gray-100">
  <div className="w-full p-4">
    <h3 className="p-5 pl-0 text-black text-2xl font-bold">11. Botón para Filtrar Roles Inactivos</h3>
    <p className="text-justify text-md">Dirígete hacia la esquina superior derecha de la tabla, allí encontrarás un botón etiquetado como 'Inactivos'. Al presionar este botón, la tabla se actualizará, permitiéndote filtrar y mostrar exclusivamente los roles que actualmente se encuentran inactivos.</p>
  </div>
  <div className="w-auto">
    <img src="https://images.tango.us/workflows/6e757d99-dd27-4488-bc5e-9141dcdba9b6/steps/19f3cf67-13ab-46a7-b13d-8d52eef284db/28fd97de-eb9e-418a-b3c4-4b42b3a83964.png?fm=png&crop=focalpoint&fit=crop&fp-x=0.8318&fp-y=0.2408&fp-z=2.8994&w=1200&border=2%2CF4F2F7&border-radius=8%2C8%2C8%2C8&border-radius-inner=8%2C8%2C8%2C8&blend-align=bottom&blend-mode=normal&blend-x=0&blend-w=1200&blend64=aHR0cHM6Ly9pbWFnZXMudGFuZ28udXMvc3RhdGljL21hZGUtd2l0aC10YW5nby13YXRlcm1hcmstdjIucG5n&mark-x=496&mark-y=343&m64=aHR0cHM6Ly9pbWFnZXMudGFuZ28udXMvc3RhdGljL2JsYW5rLnBuZz9tYXNrPWNvcm5lcnMmYm9yZGVyPTQlMkNGRjc0NDImdz0yMzgmaD0xMDMmZml0PWNyb3AmY29ybmVyLXJhZGl1cz0xMA%3D%3D" 
      width={600} height={0} alt="Botón para Filtrar Roles Inactivos" style={{ borderRadius: "8px", border: "1px solid #F4F2F7" }} />
  </div>
</div>

<div className="flex justify-between flex-col md:flex-row items-center p-5 mb-9 border rounded">
  <div className="w-auto pr-7">
    <img src="https://images.tango.us/workflows/6e757d99-dd27-4488-bc5e-9141dcdba9b6/steps/eb2e7213-bef4-4bd2-b3c4-4b42b3a83964/9a53f171-7232-4f1a-98c5-c1a241fe3e16.png?fm=png&crop=focalpoint&fit=crop&w=1200&border=2%2CF4F2F7&border-radius=8%2C8%2C8%2C8&border-radius-inner=8%2C8%2C8%2C8&blend-align=bottom&blend-mode=normal&blend-x=0&blend-w=1200&blend64=aHR0cHM6Ly9pbWFnZXMudGFuZ28udXMvc3RhdGljL21hZGUtd2l0aC10YW5g4nby13YXRlcm1hcmstdjIucG5n" 
      width={600} height={0} alt="Tabla con roles 'Inactivo' y botón para cambiar de estado a 'Activo'" style={{ borderRadius: "8px", border: "1px solid #F4F2F7" }} />
  </div>
  <div className="w-full p-4">
    <h3 className="p-5 pl-0 text-black text-2xl font-bold">12. Tabla con roles "Inactivo" y botón para cambiar de estado a "Activo"</h3>
    <h3 className="text-black text-2xl font-bold">Botón de Cambio de Estado</h3>
    <p className="text-justify text-md">Muévete con el puntero hacia la columna 'Estado'; allí verás un botón etiquetado como 'Inactivo'. Este botón te permite cambiar el estado de un rol; al hacer presionar sobre él, el rol desaparecerá de la tabla, ya que esta solo muestra los roles Inactivos.</p>
  </div>
</div>
...
<div className="flex justify-between flex-col md:flex-row items-center mb-9 p-5 border rounded bg-gray-100">
  <div className="w-full p-4">
    ...
    <p className="text-justify text-md">Dirígete hacia la esquina superior derecha de la tabla, allí encontrarás un botón etiquetado como 'Activos'. Al presionar este botón, la tabla se actualizará, permitiéndote filtrar y mostrar exclusivamente los roles que actualmente se encuentran Activos.</p>
  </div>
  <div className="w-auto">
    <img src="https://images.tango.us/workflows/6e757d99-dd27-4488-bc5e-9141dcdba9b6/steps/22202544-7fb4-47e1-ac49-eb46dce11368/5cf9dbb0-92dd-49e5-bd24-c149e7cba450.png?fm=png&crop=focalpoint&fit=crop&fp-x=0.8358&fp-y=0.2408&fp-z=2.8994&w=1200&border=2%2CF4F2F7&border-radius=8%2C8%2C8%2C8&border-radius-inner=8%2C8%2C8%2C8&blend-align=bottom&blend-mode=normal&blend-x=0&blend-w=1200&blend64=aHR0cHM6Ly9pbWFnZXMudGFuZ28udXMvc3RhdGljL21hZGUtd2l0aC10YW5nby13YXRlcm1hcmstdjIucG5n&mark-x=521&mark-y=343&m64=aHR0cHM6Ly9pbWFnZXMudGFuZ28udXMvc3RhdGljL2JsYW5rLnBuZz9tYXNrPWNvcm5lcnMmYm9yZGVyPTQlMkNGRjc0NDImdz0yMTUmaD0xMDMmZml0PWNyb3AmY29ybmVyLXJhZGl1cz0xMA%3D%3D" 
      width={1500} height={0} alt="Botón para Filtrar Roles Activos" style={{ borderRadius: "8px", border: "1px solid #F4F2F7" }} />
  </div>
</div>

<div className="flex justify-between flex-col md:flex-row items-center p-5 mb-9 border rounded">
  <div className="w-auto pr-7">
    <img src="https://images.tango.us/workflows/6e757d99-dd27-4488-bc5e-9141dcdba9b6/steps/33d71b59-7211-4102-888b-cbf7707db180/3b5354e8-7317-4a4d-8417-a6a6d8aa7783.png?fm=png&crop=focalpoint&fit=crop&fp-x=0.5000&fp-y=0.5000&w=1200&border=2%2CF4F2F7&border-radius=8%2C8%2C8%2C8&border-radius-inner=8%2C8%2C8%2C8&blend-align=bottom&blend-mode=normal&blend-x=0&blend-w=1200&blend64=aHR0cHM6Ly9pbWFnZXMudGFuZ28udXMvc3RhdGljL21hZGUtd2l0aC10YW5nby13YXRlcm1hcmstdjIucG5n" 
      width={1500} height={0} alt="Funcionalidad de Filtrado" style={{ borderRadius: "8px", border: "1px solid #F4F2F7" }} />
  </div>
  <div className="w-full p-4">
    <h3 className="p-5 pl-0 text-black text-2xl font-bold">14. Funcionalidad de Filtrado</h3>
    <p className="text-justify text-md">Al hacer clic en el botón de filtrado, la tabla se actualizará automáticamente para mostrar solo los roles que están marcados como "Activos". Los roles Inactivos se ocultarán.</p>
  </div>
</div>
...
<div className="flex justify-between flex-col md:flex-row items-center p-5 mb-9 border rounded">
  ...
  <div className="w-full p-4">
    ...
    <p className="text-justify text-md">Siguiendo el paso anterior, el menú desplegado contendrá dos botones con iconos y los nombres "Eliminar" y "Editar". Al presionar alguno de estos botones, se ejecutará una acción.</p>
    <p></p>
...
<div className="flex justify-between flex-col md:flex-row items-center mb-9 p-5 border rounded bg-gray-100">
  <div className="w-full p-4">
    ...
    <ul className="mb-9">
      <li className="mb-3">
        <strong>Campo de Nombre del Rol:</strong> Un campo de entrada de texto que muestra el nombre actual del rol. El usuario puede modificar este campo para reflejar el nuevo nombre deseado.
      </li>
    </ul>
    <h3 className="text-2xl font-bold">Mensaje de Advertencia</h3>
    <p>Justo arriba del formulario, se incluirá un mensaje claro y destacado que indica que todos los campos son obligatorios. Esto sirve como recordatorio para garantizar que el usuario complete la información necesaria.</p>
  </div>
  <div className="w-auto">
    <img src="https://images.tango.us/workflows/6e757d99-dd27-4488-bc5e-9141dcdba9b6/steps/88e09741-b76f-4e79-a4da-c4fb60a6a716/2d84813e-e29f-4313-a547-db379f4b6707.png?fm=png&crop=focalpoint&fit=crop&fp-x=0.5000&fp-y=0.5061&fp-z=1.6260&w=1200&border=2%2CF4F2F7&border-radius=8%2C8%2C8%2C8&border-radius-inner=8%2C8%2C8%2C8&blend-align=bottom&blend-mode=normal&blend-x=0&blend-w=1200&blend64=aHR0cHM6Ly9pbWFnZXMudGFuZ28udXMvc3RhdGljL21hZGUtd2l0aC10YW5nby13YXRlcm1hcmstdjIucG5n&mark-x=293&mark-y=365&m64=aHR0cHM6Ly9pbWFnZXMudGFuZ28udXMvc3RhdGljL2JsYW5rLnBuZz9tYXNrPWNvcm5lcnMmYm9yZGVyPTQlMkNGRjc0NDImdz02MTUmaD01OCZmaXQ9Y3JvcCZjb3JuZXItcmFkaXVzPTEw" 
    style={{ borderRadius: "8px", border: "1px solid #F4F2F7" }}
    width="1500" alt="Formulario de Edición" 
    />
  </div>
</div>
...
<div className="flex justify-between flex-col md:flex-row items-center p-5 mb-9 border rounded">
          ...
          <div className="w-full p-4">
            ...
            <p className="text-justify text-md"><strong>Siguiente:</strong> Un botón que, al hacer clic, guarda los cambios realizados en el nombre del rol y transfiere al usuario al segundo paso, que es la edición de permisos.</p>
          </div>
</div>
...
<div className="flex justify-between flex-col md:flex-row items-center p-5 mb-9 border rounded">
  <div className="w-auto">
    <img src="https://images.tango.us/workflows/6e757d99-dd27-4488-bc5e-9141dcdba9b6/steps/90b6ea1f-ad08-4ffb-97fc-5f36339361c7/21607f66-900e-4e96-af4a-8ce40024277e.png?fm=png&crop=focalpoint&fit=crop&fp-x=0.5000&fp-y=0.5755&fp-z=1.6260&w=1200&border=2%2CF4F2F7&border-radius=8%2C8%2C8%2C8&border-radius-inner=8%2C8%2C8%2C8&blend-align=bottom&blend-mode=normal&blend-x=0&blend-w=1200&blend64=aHR0cHM6Ly9pbWFnZXMudGFuZ28udXMvc3RhdGljL21hZGUtd2l0aC10YW5nby13YXRlcm1hcmstdjIucG5n&mark-x=293&mark-y=365&m64=aHR0cHM6Ly9pbWFnZXMudGFuZ28udXMvc3RhdGljL2JsYW5rLnBuZz9tYXNrPWNvcm5lcnMmYm9yZGVyPTQlMkNGRjc0NDImdz02MTUmaD01OCZmaXQ9Y3JvcCZjb3JuZXItcmFkaXVzPTEw" 
    width="1500" alt="Campo para añadir nombre a un rol a la hora de Registrar un nuevo rol" />
  </div>
  ...
  <div className="w-full p-4 ">
    ...
    <p className="text-justify text-md mr-9 mb-9"><strong>Campo de Nombre del Rol</strong> </p><p>Un campo de entrada de texto para ingresar el nombre del nuevo rol.</p><h3>Mensaje de Advertencia </h3><p>Justo arriba del formulario, se incluirá un mensaje claro y destacado que indica que todos los campos son obligatorios. Esto sirve como recordatorio para garantizar que el usuario complete la información necesaria.</p><p></p><p><strong>Botón siguiente</strong></p><p>Un botón que, al hacer clic, permite avanzar al segundo paso para la asignación de permisos.</p>
  </div>
