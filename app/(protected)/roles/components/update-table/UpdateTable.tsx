        ...
        <StepContent>
            <div>
            {
                Array.isArray(permissions) && Array.isArray(permissionsroles) && permissions.map((permission) => (
                    ...
                    <Switch 
                    // checked={permissionsroles.map((per) => per.id_permission).includes(permission.name)}
                    onCheckedChange={(e) => {
                            if(e === true){
...
//                                 e = true; // Activa el interruptor si el permiso está en permissionsroles
//                                 console.log('si esta', permission.name)
//                             }
//                             if(e === true){
//                                 setAssingPermission([...assingPermissions, {
//                                     id_permission: permission.id
