      ...
      <div className="mx-auto max-w-7xl p-4">
        ...
        <div className="flex justify-between flex-col md:flex-row items-center p-5 mb-9 border rounded">
          ...
          <div className="w-auto p-4">
            ...
            <p className="text-justify text-md">Al lado de las columnas <strong>{`"Cliente"`}</strong>, <strong>{`"Fecha"`}</strong>, <strong>{`"Ordenes"`}</strong>, <strong>{`"Métodos"`}, {`"Tipo"`}, {`"Total"`} y {`"Estado"`}</strong> hay un icono de orden, y al pulsarlo el ordenará la columna de manera ascendente y descendente, pulsando varias veces sobre él.</p>
          </div>    
        </div>
        ...
        <div className="flex justify-between flex-col md:flex-row items-center mb-9 p-5 border rounded bg-gray-100">
          <div className="w-full p-4">
            ...
            <p className="text-justify pr-7 text-md">Al pulsar el recuadro de <strong>{`"Seleccionar un producto"`}</strong> se desplegará una lista de todos los productos registrados en el aplicativo y puede elegir uno.</p>
          </div>
          <div className="w-full">             
